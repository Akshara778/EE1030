...
\end{multicols}
\begin{multicols}{2}
\item $P+Q = 1-x+y\\+y'+\brak{y'}^2$
\columnbreak
\item $P-Q=x+y\\-y'-\brak{y'}^2$ 
\end{multicols}
\end{enumerate}
...
\begin{enumerate}
\begin{multicols}{2}
\item $\lim\limits_{x \to 0+} f'\brak{\frac{1}{x}} = 1$
\columnbreak
\item $\lim\limits_{x \to 0+} x f'\brak{\frac{1}{x}} = 2$
\end{multicols}
\begin{multicols}{2}
\item $\lim\limits_{x \to 0+} x^2 f'\brak{x} = 0$
\columnbreak
